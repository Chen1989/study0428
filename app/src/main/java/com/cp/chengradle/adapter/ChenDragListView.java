...
/**
 * Created by PengChen on 2018/7/24.
 */

public class ChenDragListView extends ListView {

    public ChenDragListView(Context context) {
        this(context, null);
    }

    public ChenDragListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ChenDragListView(Context context, AttributeSet attrs, int defStyle) {
